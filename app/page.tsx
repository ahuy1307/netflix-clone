...
export default function Home() {
	return (
		<>
			<div className="px-[48px] h-full overflow-hidden relative">
				...
				<Navbar />
				<div className="flex flex-col gap-y-4 md:gap-y-7 mt-[50px] md:mt-[150px] text-white text-center max-w-[calc(100%-3rem)] m-auto py-6 z-[12]">
					...
					<div className="flex flex-col gap-y-4 md:flex-row justify-center ">
